    ...
    <main className="min-h-screen px-5 py-8 sm:px-6 sm:py-12">
      <section className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <SectionCard><ProfileSummary profile={profile} email={data.user.email ?? 'No email available'} /><div className="mt-4"><Link href="/dashboard/profile" className="text-sm font-medium hover:underline">Edit profile →</Link></div></SectionCard>
